...
export default function FormHook() {
  ...
  function onSubmit(values: FormHookProps) {
    const newValues = {...values, dob: formatISO(values.office.dob, { format: "basic"})}
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4 justify-center">
        <FormField
          ...
          render={({ field , fieldState}) => (
            <FormItem>
              <FormLabelValidate label="Username" htmlFor="userName" invalid={fieldState.invalid} />
              <FormControl>
        ...
        <FormField
          ...
          render={({ field, fieldState}) => (
            <FormItem>
              <FormLabel className={fieldState.invalid ? "text-red-500" : ""} htmlFor="email">Email</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field, fieldState}) => (
            <FormItem>
              <FormLabelValidate label="Password" htmlFor="password" invalid={fieldState.invalid} />
              <FormControl>
        ...
        <FormField
          ...
          render={({ field , fieldState}) => (
            <FormItem id="office-name">
              <FormLabelValidate label="Office name" htmlFor="office.name" invalid={fieldState.invalid} />
              <FormControl>
        ...
        <FormField
          ...
          render={({ field , fieldState}) => (
            <FormItem id="office-city">
              <FormLabelValidate label="Office city" htmlFor="office.city" invalid={fieldState.invalid} />
        ...
        <FormField
          ...
          render={({ field, fieldState }) => (
            <FormItem className="flex flex-col">
              <FormLabelValidate label="Date of birth" htmlFor="office.dob" invalid={fieldState.invalid} />
              <Popover>
...
function FormLabelValidate({ label, invalid, htmlFor }: { label: string, invalid?: boolean, htmlFor?: string }) {
  return (
    <FormLabel htmlFor={htmlFor} className={invalid ? "text-red-500" : ""}>{label}</FormLabel>
  )
}
